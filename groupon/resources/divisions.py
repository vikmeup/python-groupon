...
class Division( object ):
    ...
    def get( self, key, resource = None, options = None ):
        '''
        Here's how get your available Groupon Divisions:
        ...
        >>> options = {'flat':True}
        >>> status, divisions = divisionInterface.get(key, {'api':{'version':2}}, options)
        >>> 
        '''
        ...
        entrypoint = 'v%(apiVersion)d/divisions/' % {'apiVersion':apiVersion}
